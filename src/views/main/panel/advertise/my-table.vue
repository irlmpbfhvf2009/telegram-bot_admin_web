<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <!-- <el-table-column prop="groupId" label="名称" align="center" /> -->
        <!-- <el-table-column prop="groupTitle" label="群组" align="center" /> -->
        <el-table-column prop="advertiseContent" label="广告内容" align="center" />
        <el-table-column prop="advertiseTime" label="间隔秒数" align="center" />
...
import { getAdvertiseData } from '@/api/app'
...
export default defineComponent({
  ...
  setup() {
    ...
    const getTableData = (init) => {
      ...
      let params = {
        category: activeCategory.value.groupId,
        page: page.index,
        pageSize: page.size,
        ...query
      }
